class Mutator
  PHONE_TEXT = "\n\n🚀 ВСЁ для работы и отдыха в TopChinaShop! Генераторы ❄️Автохолодильники 🚲 Велики (в т.ч. курьерские) ⚡ Шуруповерты/Гайковерты/Бензопилы 🛠️ Ручной инструмент. ЗВОНИТЕ Фёдору: 8-913-590-4-777!"
